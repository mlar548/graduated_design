...
//	供应商添加
	$('.addSupplierBtn').click(function() {
		...
		window.location.href=url;
		//将iframeObj传递给父级窗口,执行操作完成刷新
		/*parent.page(msg, url, iframeObj, w = "770px", h = "550px");*/
		return false;
		
	}).mouseenter(function() {
		var msg=$(this).attr('data-msg');
		dialog.tips(msg, '.addSupplierBtn');
...
//	弹框
	$('.toBtn').click(function() {
		...
		/*window.location.href=url;*/
//		 将iframeObj传递给父级窗口,执行操作完成刷新
		 parent.page(msg, url, iframeObj, w = width, h = height); 
		return false;
...
//	myBtn
	$('.myBtn').click(function() {
		...
		//将iframeObj传递给父级窗口,执行操作完成刷新
		window.location.href=url;
		/*parent.page("修改", url, iframeObj, w = "700px", h = "620px");*/
		return false;
