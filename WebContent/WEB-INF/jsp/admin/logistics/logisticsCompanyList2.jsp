...
<div id="divSupplierTable">
	<table border="1px" class="table table-hover" style="width: 96% ;margin: 0 auto">
		...
		<tr>
			...
			<td>${logisticsCompany.logisticsName}</td>
			<td>${logisticsCompany.phone}</td>
			 
			<td><a class="btn btn-info" role="button" href="${pageContext.request.contextPath}/logisticsCompanyUpdate?id=${logisticsCompany.id}">修改</a>  </td>
