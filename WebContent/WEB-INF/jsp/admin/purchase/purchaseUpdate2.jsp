...
<body>
	<form class="form-inline" id="signupForm"
		...
		<div class="tianjia">
			...
			<div class="form-group">
				<label>出单人：</label> <input type="text" name="employeeId" value="${purchase.employeeId}"
				...
				<table class="layui-table" lay-even lay-skin="nob">
					...
					<tbody id="thisthead">
						...
						<tr>
							...
							<td>1</td>
							<td><select name="purchasetrade[0].goodsId" style="width: 240px"
							...
							<td><input type="text" name="purchasetrade[0].quantity" value="30" id=""
								...
								style="width: 110px" class="form-control" /></td>
							<td></td>
							<input type="hidden" name="purchasetrade[0].purchaseId" value="${purchase.purchaseId}">
						</tr>
						...
						<tr id="tr2">
							...
							<td>2</td>
							<td><select name="purchasetrade[1].goodsId" style="width: 240px"
								class="form-control goodselect">
									<c:forEach var="goods" items="${goodsList}">
										<option value="${goods.goodsId}">
											${goods.goodsName}</option>
							...
							<td><input type="text" name="purchasetrade[1].onePrice" value="" id=""
								style="width: 70px" class="form-control" /></td>
							<td><input type="text" name="purchasetrade[1].quantity" value="30" id=""
								style="width: 60px" class="form-control" /></td>
						 
								<td><input type="text" name="purchasetrade[1].description" value="" id=""
								style="width: 110px" class="form-control" /></td>
							<td id="del2"><a href="javascript:;"
								onclick="removeElementtr('tr2')">删除</a></td>
									<input type="hidden" name="purchasetrade[1].purchaseId" value="${purchase.purchaseId}">
						</tr>
