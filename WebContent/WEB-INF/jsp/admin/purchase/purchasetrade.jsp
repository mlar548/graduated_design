...
<body>
	<form class="form-inline" id="signupForm"
		...
		<div class="tianjia">
			<br>
			<center>
				<label class="labeltop">采购信息</label>
			</center>
			<center>
				<hr>
			</center>
...
<br>
<c:if test="${purchase.other!=null}">
<div class="form-group thismyleft">
				<label class="mylabel redlabel">不通过原因：${purchase.other}</label> 
			</div>
<br><br>
</c:if>
			<div class="form-group thismyleft">
...
<div class="form-group">
	...
	<center>
 	...
 	<a href="${pageContext.request.contextPath}/purchaseUpdate?id=${purchase.id}" type="button"  class="btn btn-info" >修改</a>
		 &nbsp; &nbsp;
	</c:if>
		 
 	<a href="javascript:history.go(-1);" type="button"  class="btn btn-success" >返回</a>
		</center>
	</form>
